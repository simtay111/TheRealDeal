...
namespace RecreateMe.Tests.Friends.Invites
{
    [TestFixture]
    public class InviteSenderTests
    {
        ...
        public void CanSetGameId()
         {
            CreateInviteSender();
             ...
             Assert.That(_inviteSender.EventId, Is.EqualTo(_eventId));
         }
        ...
        public void CanSetSenderId()
        {
            ...
            Assert.That(_inviteSender.SenderId, Is.EqualTo(_senderId));
        }
