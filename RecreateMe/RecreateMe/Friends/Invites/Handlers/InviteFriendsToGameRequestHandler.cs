...
{
    public class InviteFriendsToGameRequestHandler : IHandler<InviteFriendsToGameRequest, InviteFriendsToGameResponse>
    {
        private readonly IInviteSender _inviteSender;

        public InviteFriendsToGameRequestHandler(IInviteSender inviteSender)
        {
