...
{
    public class SearchForFriendsRequestHandle : IHandle<SearchForFriendsRequest, SearchForFriendsResponse>
    {
        private readonly IProfileRepository _profileRepository;

        public SearchForFriendsRequestHandle(IProfileRepository profileRepository)
        {
