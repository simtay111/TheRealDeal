...
{
    public class AddSportToProfileRequestHandle : IHandle<AddSportToProfileRequest, AddSportToProfileResponse>
    {
        private readonly IProfileRepository _profileRepository;
        private readonly ISportRepository _sportRepository;

        public AddSportToProfileRequestHandle(IProfileRepository profileRepository, ISportRepository sportRepository)
        {
