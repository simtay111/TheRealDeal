...
{
    public class DeleteTeamGameRequestHandle : IHandle<DeleteTeamGameRequest, DeleteTeamGameResponse>
    {
        private readonly ITeamGameRepository _teamGameRepository;

        public DeleteTeamGameRequestHandle(ITeamGameRepository teamGameRepository)
        {
