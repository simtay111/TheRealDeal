...
{
    public class DeletePickUpGameRequestHandle : IHandle<DeletePickUpGameRequest, DeletePickUpGameResponse>
    {
        private readonly IPickUpGameRepository _pickUpGameRepository;

        public DeletePickUpGameRequestHandle(IPickUpGameRepository pickUpGameRepository)
        {
